...
const England = () => {
  ...
  const getDatat = async () => {
    await axios
      .get(
        "https://apiv2.allsportsapi.com/football/?&met=Topscorers&leagueId=152&APIkey=c6934c58fbacf10be4d035169eaf4e5198e3b47384fd07acc490fa7d075b66a0"
      )
      .then((respose) => {
  ...
  const getData = async () => {
    await axios
      .get(
        "https://apiv2.allsportsapi.com/football/?&met=Standings&leagueId=152&APIkey=c6934c58fbacf10be4d035169eaf4e5198e3b47384fd07acc490fa7d075b66a0"
      )
      .then((respose) => {
