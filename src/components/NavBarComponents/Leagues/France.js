...
const France = () => {
  ...
  const getDatat = async () => {
    await axios
      .get(
        "https://apiv2.allsportsapi.com/football/?&met=Topscorers&leagueId=168&APIkey=352d0aae96e3a4bb970dddca2cb8ed2851ce56f17dc0b14e0764c03b03db8ef5"
      )
      .then((respose) => {
  ...
  const getData = async () => {
    await axios
      .get(
        "https://apiv2.allsportsapi.com/football/?&met=Standings&leagueId=168&APIkey=352d0aae96e3a4bb970dddca2cb8ed2851ce56f17dc0b14e0764c03b03db8ef5"
      )
      .then((respose) => {
        ...
        <div>
          ...
          >
            <div style={{ marginLeft: "50px" }}>
              <img
                src="https://a.espncdn.com/combiner/i?img=/i/leaguelogos/soccer/500/9.png"
                height={"90px"}
                alt="Premier"
              />
            </div>
